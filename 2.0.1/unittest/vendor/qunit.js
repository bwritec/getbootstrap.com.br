...
(function(window)
{
    ...
    Test.prototype = {
        ...
        setup: function()
        {
            ...
            /**
             * Permitir que funções utilitárias acessem o ambiente de
             * teste atual. Questão por quê ?
             */
    ...
    var QUnit = {
        ...
        start: function()
        {
            ...
            {
                /**
                 * Não comece até que haja um número igual
                 * de chamadas de parada.
                 */
                return;
            }
            ...
            /**
             * Um pequeno atraso, para evitar retornos de
             * chamada atuais.
             */
    ...
    /**
     * Compatibilidade com versões anteriores, obsoleta.
     */
    ...
    var config = {
        ...
        /**
         * Quando ativado, mostra apenas testes com falha. é
         * persistido por meio do sessionStorage e pode ser
         * alterado na UI por meio da checkbox.
         */
        hidepassed: false,
        ...
        /**
         * Por padrão, modifique document.title quando o
         * conjunto estiver concluído.
         */
        altertitle: true,
    ...
    /**
     * Exponha a API como variáveis globais, a menos que
     * exista um objeto de 'exportação'; nesse caso,
     * assumimos que estamos em CommonJS.
     */
    ...
    extend(QUnit, {
         ...
         * com as propriedades listadas. Fazer o procedimento de
         * test/logs.html para quaisquer alterações relacionadas.
         */
        begin: function()
        {
        },
    ...
    function done()
    {
        ...
        if (config.altertitle && typeof document !== "undefined" && document.title)
        {
             ...
             * no título. Use sequências de escape caso o arquivo
             * seja carregado com conjunto de caracteres não utf-8.
             */
            document.title = [
                (config.stats.bad ? "\u2716" : "\u2714"),
    ...
    /**
     * Devolve um novo Array com os elementos que estão em
     * a mas não em b.
     */
    function diff(a, b)
    {
    ...
    QUnit.equiv = function ()
    {
        ...
        /**
         * Stack para decidir entre pular/terminar funções.
         */
        var callers = [];
        ...
        var callbacks = function ()
        {
            ...
            function useStrictEquality(b, a)
            {
                if (b instanceof a.constructor || a instanceof b.constructor)
                {
                     ...
                     * anotação de uma declaração. Exemplo:  var i = 1;
                     *
                     * var j = new Number(1);
                     */
                    return a == b;
            ...
            return {
                ...
                "object" : function(b, a)
                {
                    ...
                    /**
                     * Comparar construtores é mais rigoroso do que
                     * usar instanceof.
                     */
                    ...
                    /**
                     * Construtor de pilha antes de percorrer as propriedades.
                     */
                    ...
                    {
                        /**
                         * Seja rigoroso: não garanta hasOwnProperty
                         * e vá fundo.
                         */
                        loop = false;
    ...
    QUnit.jsDump = (function()
    {
        ...
        var jsDump = {
            ...
            {
                /**
                 * Extra pode ser um número, atalho para aumentar
                 * chamar ou diminuir.
                 */
                if (!this.multiline)
                {
            ...
            /**
             * Os próximos 3 estão expostos para que você possa
             * usá-los.
             */
            quote: quote,
            literal: literal,
            ...
            parsers: {
                ...
                /**
                 * Função chama internamente, são os argumentos
            ...
            /**
             * Se for true, as entidades são escapadas
             * ( <, >, \t, space and \n ).
             */
            HTML: false,
    ...
    function getText(elems)
    {
        ...
        for (var i = 0; elems[i]; i++)
        {
            ...
            /**
             * Obtenha o texto dos nodes de texto e dos nodes CDATA.
             */
            if (elem.nodeType === 3 || elem.nodeType === 4)
            {
                ...
                /**
                 * Percorra todo o resto, exceto os nodes de comentários.
                 */
     ...
     *
     * QUnit.diff("a rápida raposa marrom saltou", "a rápida raposa salta") == "a rápida raposa <del>marrom </del> <del>saltou </del><ins>salta </ins> sobre"
     */
    QUnit.diff = (function()
    {
        /**
