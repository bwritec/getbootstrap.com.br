...
(function(window)
{
    ...
    var QUnit = {
        ...
        start: function()
        {
            ...
            {
                /**
                 * Não comece até que haja um número igual de
    ...
    var config = {
        ...
        /**
         * Quando ativado, mostra apenas testes com falha.
         * É persistido por meio do sessionStorage e pode
         * ser alterado na UI por meio da caixa de seleção.
         */
        hidepassed: false,
    ...
    (function()
    {
        ...
        /**
         * Descubra se estamos executando os testes em
         * um servidor ou não.
         */
    ...
    extend(QUnit, {
        ...
        /**
         * Registrando retornos de chamada; todos recebem um
         * único argumento com as propriedades listadas, execute
    ...
    QUnit.load = function()
    {
        ...
        /**
         * Inicialize a configuração, salvando a fila
         * de execução.
         */
     ...
     * podendo ser estendido no futuro para usar algo como
    ...
    /**
     * Retorna um novo Array com os elementos que estão
     * em a mas não em b.
     */
    function diff(a, b)
    {
    ...
    QUnit.equiv = function ()
    {
        ...
        /**
         * Pilha para decidir entre pular/abortar funções.
         */
        var callers = [];
        ...
        /**
         * Chame o retorno de chamada relacionado com os
        ...
        {
            /**
             * Para string, booleano, número e null.
             */
            ...
            return {
                ...
                /**
                 * - Pule quando a propriedade for um método de
                 *   uma instância (OOP).
                 * - Abortar caso contrário,
                 *
                 * initial === Teria capturado referências idênticas
                 *             de qualquer maneira.
                 */
                "function" : function()
                {
    ...
    QUnit.jsDump = (function()
    {
        ...
        var jsDump = {
            ...
            /**
             * Os próximos 3 estão expostos para que você
             * possa usá-los.
             */
            quote:quote,
            ...
            parsers:{
                ...
                /**
                 * Function chama internamente, é o conteúdo da
                 * função.
                 */
                functionCode:'[code]',

                /**
                 * Node chama isso internamente, é um valor de atributo html.
                 */
                attribute:quote,
